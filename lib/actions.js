...
export const adminActions = createActions({
  START_EDIT_VIDEO: videoId => ({ videoId }),
...
export const updateVideo = () => {
  return (dispatch, getState) => {
    ...
    const video = state.data.editing.form
...
export const addNewConference = () => {
  return (dispatch, getState) => {
    const state = getState()
    const token = state.auth.token
    const conference = state.data.editing.add.conference
...
export const addNewSpeaker = () => {
  return (dispatch, getState) => {
    const state = getState()
    const token = state.auth.token
    const speaker = state.data.editing.add.speaker
...
export const addNewTag = () => {
  return (dispatch, getState) => {
    const state = getState()
    const token = state.auth.token
    const tag = state.data.editing.add.tag
